...
public class JwtUtilsRefreshTest {
    ...
    void setUp() {
        ...
        testUser.setDeptTags("org1,org2");
        testUser.setPrimaryDept("org1");
    ...
    void testExtractClaimsFromValidToken() {
        ...
        assertEquals("org1,org2", deptTags);
        
        String primaryDept = jwtUtils.extractPrimaryDeptFromToken(token);
        assertEquals("org1", primaryDept);
    }
}

package com.huayu.smartqa.entity;
...
public class SearchResult {
    ...
    public SearchResult(String fileMd5, Integer chunkId, String textContent, Double score, String userId, String deptTag, boolean isPublic) {
        this(fileMd5, chunkId, textContent, score, userId, deptTag, isPublic, null, null, null, null, null);
    }

    public SearchResult(String fileMd5, Integer chunkId, String textContent, Double score, String userId, String deptTag, boolean isPublic, String fileName) {
        this(fileMd5, chunkId, textContent, score, userId, deptTag, isPublic, fileName, null, null, null, null);
    }

    public SearchResult(String fileMd5, Integer chunkId, String textContent, Double score, String userId, String deptTag,
                        boolean isPublic, String fileName, Integer pageNumber, String anchorText) {
        this(fileMd5, chunkId, textContent, score, userId, deptTag, isPublic, fileName, pageNumber, anchorText, null, textContent);
    }

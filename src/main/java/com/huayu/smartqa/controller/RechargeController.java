...
import com.huayu.smartqa.service.RechargeService;
import com.huayu.smartqa.service.WxPayService;
...
public class RechargeController {
    ...
    public ResponseEntity<?> getPackages() {
        try {
            List<com.huayu.smartqa.model.RechargePackage> packages = rechargeService.getAllPackages();

...
import com.huayu.smartqa.service.ElasticsearchService;
import com.huayu.smartqa.service.ParseService;
import com.huayu.smartqa.service.VectorizationService;
...
public class BootstrapKnowledgeInitializer implements CommandLineRunner {
    ...
    private String bootstrapDeptTag;
    ...
    private boolean isBootstrapDocumentReady(String fileMd5, String fileName, String ownerUserId) {
        ...
        boolean metadataMatches = fileName.equals(fileUpload.getFileName())
                && bootstrapDeptTag.equals(fileUpload.getDeptTag())
    ...
    private void importBootstrapDocument(Path documentPath, String fileMd5, String fileName, long totalSize, String ownerUserId)
        ...
        try (InputStream inputStream = Files.newInputStream(documentPath)) {
            parseService.parseAndSave(fileMd5, inputStream, ownerUserId, bootstrapDeptTag, bootstrapPublic);
        } catch (Exception e) {
            cleanupBootstrapData(fileMd5, ownerUserId);
            throw e;
        }
        ...
        try {
            vectorizationService.vectorize(fileMd5, ownerUserId, bootstrapDeptTag, bootstrapPublic, bootstrapUserId);
            ...
            fileUpload.setDeptTag(bootstrapDeptTag);

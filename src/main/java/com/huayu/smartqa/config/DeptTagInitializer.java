...
public class DeptTagInitializer implements CommandLineRunner {
    private static final Logger logger = LoggerFactory.getLogger(DeptTagInitializer.class);
    ...
    public void run(String... args) throws Exception {
        ...
        // 创建默认组织标签
        createDepartmentTagIfNotExists(DEFAULT_TAG, DEFAULT_NAME, DEFAULT_DESCRIPTION, adminUser);
        
        // 创建管理员组织标签
        createDepartmentTagIfNotExists(ADMIN_TAG, ADMIN_NAME, ADMIN_DESCRIPTION, adminUser);
     ...
     * 如果组织标签不存在，则创建
     */
    private void createDepartmentTagIfNotExists(String tagId, String name, String description, User creator) {
        ...
        if (!DepartmentTagRepository.existsByTagId(tagId)) {
            ...
            DepartmentTagRepository.save(tag);

...
import com.huayu.smartqa.model.RechargeOrder;
import com.huayu.smartqa.model.RechargeOrder.OrderStatus;
import com.huayu.smartqa.model.RechargePackage;
import com.huayu.smartqa.repository.RechargeOrderRepository;
import com.huayu.smartqa.repository.RechargePackageRepository;
import com.huayu.smartqa.utils.PriceUtil;
...
public class RechargeService {
    ...
    public WxPayService.PrePayInfoResBo createRechargeOrder(
        ...
        if (packageId != null && packageId > 0) {
            ...
            description = "【化语智答】充值套餐：" + rechargePackage.getPackageName();
        } else {
            // 自定义充值
            ...
            description = "【化语智答】自定义充值￥" + PriceUtil.toYuanPrice(amount) + "元";
        }

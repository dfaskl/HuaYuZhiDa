...
public class DocumentService {
     ...
     *
     * @param userId 用户ID
     * @param deptTags 用户所属的组织标签（逗号分隔的字符串，仅供兼容性使用）
     * @return 用户可访问的文件列表
     */
    public List<FileUpload> getAccessibleFiles(String userId, String deptTags) {
        ...
        try {
            ...
            List<String> userEffectiveTags = DeptTagCacheService.getUserEffectiveDeptTags(user.getUsername());

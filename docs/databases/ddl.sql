CREATE TABLE users (
                       ...
                       dept_tags VARCHAR(255) DEFAULT NULL COMMENT '用户所属院系标签，多个用逗号分隔',
                       primary_dept VARCHAR(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用户主院系标签',
...
CREATE TABLE department_tags (
                                   ...
                                   created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                   updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                                   FOREIGN KEY (parent_tag) REFERENCES department_tags(tag_id) ON DELETE SET NULL,
                                   FOREIGN KEY (created_by) REFERENCES users(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='院系标签表';
...
CREATE TABLE file_upload (
                             ...
                             dept_tag     VARCHAR(50)      DEFAULT NULL COMMENT '院系标签',
...
CREATE TABLE document_vectors (
                                  ...
                                  dept_tag VARCHAR(50) COMMENT '文件所属院系标签',
